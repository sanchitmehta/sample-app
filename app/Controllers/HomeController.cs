...
namespace SampleApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController()
        {
            ...
            // The environment variable SQL_CONNECTION_STRING should now include Active Directory authentication parameters.
            ...
            // Instantiate DefaultAzureCredential (ensure Azure.Identity version is 1.12.1 or higher)
