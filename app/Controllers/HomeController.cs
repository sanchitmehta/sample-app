...
namespace SampleApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            connectionString = "Server=oa-demo-sql-stage.database.windows.net,1433;Database=products;Authentication=Active Directory Default;TrustServerCertificate=True;";
        }
