...
namespace SampleApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            // eg: Server=tcp:<server>,1433;Initial Catalog=<database-name>;Authentication=Active Directory Default;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;
